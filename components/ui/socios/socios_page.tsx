...
export const Socios = () => {
    const socios = [
        ...
        { img: ARQUITECTOS, alt: "Arquitektos" },
        { img: AMAZONIA, alt: "Amazonía" },
        { img: ARENA_VERDE, alt: "Arena Verde" },
        { img: ARQUITEKTURAS, alt: "Arquitekturas" },
        { img: ASESORANDES, alt: "Asesorandes" },
        { img: ATRIS, alt: "ATRIS" },
        { img: AWANALLAQTA, alt: "Awanallqta" },
        { img: AYLLY, alt: "Aylly" },
        { img: BANCA_S, alt: "Banca Sostenible" },
        { img: CAFE_COMPADRE, alt: "Compadre" },
        { img: CALMA, alt: "CALMA" },
        { img: CIRCLE, alt: "Circle" },
        { img: CIUDAD_SALUDABLE, alt: "Ciudad Saludable" },
        { img: CLIMETRIA, alt: "Climetria" },
        { img: CMNJAN, alt: "CMSAC" },
        { img: CONCEIBA, alt: "Conceiba" },
        { img: COSMOBEAUTY, alt: "Cosmo Beauty" },
        { img: CREALIZ, alt: "Crealiz" },
