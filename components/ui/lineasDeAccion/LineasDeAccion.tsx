                ...
                <div className="flex flex-col gap-y-12 sm:gap-y-16 md:gap-y-20 justify-start">
                    ...
                    <div className="flex flex-wrap justify-center sm:justify-start gap-8 sm:gap-12 md:gap-16">
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={SER_SOSTE} alt="Capital Natural y Bioeconomía Regenerativa" width={100} height={100} className="mb-4" />
                        ...
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={PRODUCT_SOSTE} alt="Territorios Resilientes y Transición Justa" width={100} height={100} className="mb-4" />
                        ...
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={CIUD_SOSTE} alt="Industria Circular y Competitividad Sostenible" width={100} height={100} className="mb-4" />
                            <h3 className="text-lg sm:text-xl text-[#101828] font-semibold mb-2 leading-7 text-center sm:text-left">
                        ...
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={RECURSOS} alt="Turismo Regenerativo y Economías Creativas" width={100} height={100} className="mb-4" />
                            <h3 className="text-lg sm:text-xl text-[#101828] font-semibold mb-2 leading-7 text-center sm:text-left">
                        ...
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={Tarjeta005} alt="Finanzas e Innovación para el Impacto" width={100} height={100} className="mb-4" />
                            <h3 className="text-lg sm:text-xl text-[#101828] font-semibold mb-2 leading-7 text-center sm:text-left">
                        ...
                        <div className="rounded-lg p-6 flex flex-col items-center sm:items-start justify-start bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[250px] md:w-[300px]">
                            <Image src={Tarjeta006} alt="Bienestar Humano y Sistemas Alimentarios Sostenibles" width={100} height={100} className="mb-4" />
                            <h3 className="text-lg sm:text-xl text-[#101828] font-semibold mb-2 leading-7 text-center sm:text-left">
